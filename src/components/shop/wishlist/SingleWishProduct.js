              ...
              >
                ...
                <div className="md:w-1/2 md:flex md:items-center md:justify-around">
                  ...
                  <div
                    ...
                    onClick={(e) => history.push(`/products/${product._id}`)}
                    className="inline-block px-4 py-2 text-white text-xs md:text-base text-center cursor-pointer hover:opacity-75 rounded-lg"
                  >
                    Lihat
                  </div>
                </div>
  ...
  return (
    <Fragment>
      <section className="mx-4 mt-20 md:mx-12 md:mt-32 lg:mt-24">
        <div className="text-2xl mx-2 mb-6">Wishlist / daftar Keinginan</div>
        {/* Product List */}
        <Product />
      </section>
    </Fragment>
