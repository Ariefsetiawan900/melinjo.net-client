...
const Navber = (props) => {
  ...
  const getNavLinkClass = (path) =>{
    return location.pathname === path ? "text-green-700 font-medium": ""
  }
  return (
    <Fragment>
      {/* Navber Section */}
      <nav className="fixed top-0 w-full z-10 shadow-md lg:shadow-none bg-white">
        <div className="m-4 md:mx-12 md:my-6 grid grid-cols-4 lg:grid-cols-3">
          <div className="hidden lg:block col-span-1 flex text-gray-600 mt-1">
            <span
              className={`hover:bg-gray-200 px-4 py-3 rounded-lg font-light tracking-widest hover:text-gray-800 cursor-pointer ${getNavLinkClass("/")}`}
              ...
              <svg
                className={`${
                  location.pathname === "/wish-list"
                    ...
                    : ""
                } w-8 h-8 text-red-600 cursor-pointer`}
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
                xmlns="http://www.w3.org/2000/svg"
