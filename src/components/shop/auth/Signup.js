    ...
    <Fragment>
      ...
      <form className="space-y-4">
        ...
        <div className="flex flex-col">
          <label htmlFor="name">
            Nama<span className="text-sm text-gray-600 ml-1">*</span>
          </label>
          <input
        ...
        <div className="flex flex-col">
          <label htmlFor="password">
            Kata Sandi<span className="text-sm text-gray-600 ml-1">*</span>
          </label>
          <input
        ...
        <div className="flex flex-col space-y-2 md:flex-row md:justify-between md:items-center">
          <div>
            ...
            <label htmlFor="rememberMe">
              Ingatkan Saya<span className="text-sm text-gray-600">*</span>
            </label>
          </div>
        ...
        <div
          ...
          className="px-4 py-2 text-white text-center cursor-pointer font-medium rounded-md"
        >
          Create an account
        </div>
      </form>
