    ...
    <Fragment>
      <div className="flex flex-col md:flex-row items-center justify-center">
        <div
          ...
          className={`${
            data.menu ? "border-b-2 border-green-600" : ""
...
const ProductDetailsSectionTwo = (props) => {
  ...
  return (
    <Fragment>
      ...
      <div className="m-4 md:mx-8 md:my-6 flex justify-center capitalize font-light tracking-widest bg-white border-t border-b text-green-700 px-4 py-4 space-x-4">
        <div>
          <span>Kategori :</span>
